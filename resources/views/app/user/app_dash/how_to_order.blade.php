    ...
    <div class="container">
        <div class="card mb-0 bb" width="100%">
            <div class="text-center img-center mt-3 ml-3 mr-3">
                ...
                <img src="{{ URL::asset('/style/front/img/ggflogo.png') }}" class="img-fluid w-100 d-block"><hr>
                ...
                <img src="{{ URL::asset('/style/front/img/ggflogo.png') }}" class="img-fluid w-100 d-block"><br>
                <hr>
